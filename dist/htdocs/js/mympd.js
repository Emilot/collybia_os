...
function appInit() {
    ...
    document.getElementById('selectNasMode').addEventListener('change', function () {
        let value = this.options[this.selectedIndex].value;
        if (value === '0') {
            document.getElementById('inputNasPath').setAttribute('disabled', 'disabled');
            document.getElementById('inputNasFolder').setAttribute('disabled', 'disabled');
            document.getElementById('inputNasUser').setAttribute('disabled', 'disabled');
            document.getElementById('inputNasPass').setAttribute('disabled', 'disabled');
        }
        else if (value === '2') {
            document.getElementById('inputNasPath').removeAttribute('disabled');
            document.getElementById('inputNasFolder').removeAttribute('disabled');
            document.getElementById('inputNasUser').removeAttribute('disabled');
            document.getElementById('inputNasPass').removeAttribute('disabled');
        }
        else if (value === '1') {
            document.getElementById('inputNasPath').removeAttribute('disabled');
            document.getElementById('inputNasFolder').removeAttribute('disabled');
...
function inplaceUpdate() {
    sendAPI("MYMPD_API_INPLACE_UPDATE", {});
}

function parseSettings() {
    toggleBtnChk('btnSpotify', settings.spotify);
    document.getElementById('inputSpotifyUser').value = settings.spotifyuser;
    document.getElementById('inputSpotifyPass').value = settings.spotifypass;

    toggleBtnChk('btnTidal', settings.tidal);
    document.getElementById('inputTidalUser').value = settings.tidaluser;
    document.getElementById('inputTidalPass').value = settings.tidalpass;

    toggleBtnChk('btnQobuz', settings.qobuz);
    document.getElementById('inputQobuzUser').value = settings.qobuzuser;
    document.getElementById('inputQobuzPass').value = settings.qobuzpass;

    document.getElementById('selectNasMode').value = settings.nasmode;
    document.getElementById('inputNasPath').value = settings.naspath;
    document.getElementById('inputNasFolder').value = settings.nasfolder;
    document.getElementById('inputNasPass').value = settings.naspass;
    document.getElementById('inputNasUser').value = settings.nasuser;

    document.getElementById('selectVolumeMode').value = settings.volume;
    document.getElementById('collybiaVersion').innerText = settings.collybiaversion;

       document.getElementById('btnUpdate').value = settings.collybiaupdate;
        if (settings.collybiaupdate === false) {
	    document.getElementById('updateFieldset').disabled = true;
        }
        else if (settings.collybiaupdate === true) {
	    document.getElementById('updateFieldset').disabled = false;
        }

        if (settings.nasmode === '0') {
            document.getElementById('inputNasPath').setAttribute('disabled', 'disabled');
            document.getElementById('inputNasFolder').setAttribute('disabled', 'disabled');
            document.getElementById('inputNasUser').setAttribute('disabled', 'disabled');
            document.getElementById('inputNasPass').setAttribute('disabled', 'disabled');
        }
        else if (settings.nasmode === '2') {
            document.getElementById('inputNasPath').removeAttribute('disabled');
            document.getElementById('inputNasFolder').removeAttribute('disabled');
            document.getElementById('inputNasUser').removeAttribute('disabled');
            document.getElementById('inputNasPass').removeAttribute('disabled');
        }
        else if (settings.nasmode === '1') {
            document.getElementById('inputNasPath').removeAttribute('disabled');
            document.getElementById('inputNasFolder').removeAttribute('disabled');
            document.getElementById('inputNasUser').setAttribute('disabled', 'disabled');
            document.getElementById('inputNasPass').setAttribute('disabled', 'disabled');
...
function saveCollybiaSettings() {
    let selectNasMode = document.getElementById('selectNasMode');
    let selectVolumeMode = document.getElementById('selectVolumeMode');
        sendAPI("MYMPD_API_SETTINGS_SET", {
            "spotify": (document.getElementById('btnSpotify').classList.contains('active') ? true : false),
            "spotifyuser": document.getElementById('inputSpotifyUser').value,
            "spotifypass": document.getElementById('inputSpotifyPass').value,
            "tidal": (document.getElementById('btnTidal').classList.contains('active') ? true : false),
            "tidaluser": document.getElementById('inputTidalUser').value,
            "tidalpass": document.getElementById('inputTidalPass').value,
            "qobuz": (document.getElementById('btnQobuz').classList.contains('active') ? true : false),
            "qobuzuser": document.getElementById('inputQobuzUser').value,
            "qobuzpass": document.getElementById('inputQobuzPass').value,
            "nasmode": parseInt(selectNasMode.options[selectNasMode.selectedIndex].value),
            "naspath": document.getElementById('inputNasPath').value,
            "nasfolder": document.getElementById('inputNasFolder').value,
            "nasuser": document.getElementById('inputNasUser').value,
            "naspass": document.getElementById('inputNasPass').value,
            "volume": selectVolumeMode.options[selectVolumeMode.selectedIndex].value,
            "roon": (document.getElementById('btnRoon').classList.contains('active') ? true : false),
            "collybiaversion": document.getElementById('collybiaVersion').innerText,
            "collybiaupdate": (document.getElementById('btnUpdate').classList.contains('active') ? true : false),
...
function parseStats(obj) {
    ...
    document.getElementById('collybiaVersion').innerText = obj.result.collybiaVersion;
